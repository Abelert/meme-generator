...
*/
function clearAll() {
    const memeC = document.querySelector('.meme');
    const jokeC = document.querySelector('.joke');
    const quoteC = document.querySelector('.quote');
    const riddleC = document.querySelector('.riddle');
      memeC.innerHTML = '';
      jokeC.innerHTML = '';
      quoteC.innerHTML = '';
      riddleC.innerHTML = '';
    ...
    */
    function showMeme() {
      ...
      const memeCont = document.querySelector('.meme');
      const memeImg = document.createElement('img');
      memeImg.setAttribute('src', randomMemeUrl);
      clearAll();
      memeCont.appendChild(memeImg);
    }
    ...
    */
    function showQuote() {
      ...
      clearAll();
      quoteCont.appendChild(quoteP);
      quoteCont.appendChild(authorP);
    }
    ...
    */
    function showRiddle() {
      ...
      const riddleCont = document.querySelector('.riddle');
      const questionP = document.createElement('p');
      const answerP = document.createElement('p');
      questionP.textContent = randomRiddle.question;
      answerP.textContent = 'The answer is: ' + randomRiddle.answer;
      answerP.setAttribute('id', 'ans');
      answerP.hidden = 'true';
      clearAll();
      riddleCont.appendChild(questionP);
      riddleCont.appendChild(answerP);
    }
    ...
    */
    function revealAnswers() {
      const riddleCon = document.querySelector('.riddle');
      const answerR = document.querySelector('#ans');
      if(riddleCon.querySelector('p') === null)
        alert('There is no riddle!');
      else if(riddleCon.querySelector('p') && !answerR.hidden)  
